...
export function M17Slide({ scan }: { scan: ScanWithResults }) {
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.5em', marginBottom: '0.5em', paddingBottom: '0.5em', borderBottom: '1px solid rgba(255,178,239,0.06)' }}>
          {[
            ...
            <div key={i} style={{
              ...
              <p className="font-data tabular-nums" style={{ fontSize: 'clamp(16px, 1.8cqi, 22px)', fontWeight: 700, lineHeight: 1.2, color: s.color }}>
                {s.value}
              </p>
        ...
        <div style={{ display: 'flex', gap: '3%' }}>
          ...
          <div style={{ flex: 1 }}>
            <p className="font-display uppercase" style={{ fontSize: 'clamp(12px, 1.2cqi, 13px)', letterSpacing: '0.18em', color: 'var(--gs-base)', marginBottom: '0.3em' }}>
          ...
          <div style={{ flex: '0 0 38%', display: 'flex', flexDirection: 'column', gap: '0.4em' }}>
            ...
            {!hasBenefits && externalLinks.length === 0 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3em' }}>
                <p className="font-data" style={{ fontSize: 'clamp(12px, 1.15cqi, 13px)', color: 'var(--gs-mid)', opacity: 0.6 }}>
