        ...
        {topFive.length > 0 && (
          <div>
            ...
            <div style={{
              ...
              <span className="font-data" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-mid)', whiteSpace: 'nowrap' }}>Keyword</span>
              <span className="font-data" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right', whiteSpace: 'nowrap' }}>Cost</span>
              <span className="font-data" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right', whiteSpace: 'nowrap' }}>CPC</span>
              <span className="font-data" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right', whiteSpace: 'nowrap' }}>Volume</span>
              <span className="font-data" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right', whiteSpace: 'nowrap' }}>Pos</span>
            </div>
            {/* Table rows */}
                ...
                return (
                  <div key={i} style={{
                    ...
                    <span className="font-data tabular-nums" style={{
                      fontSize: 'clamp(1px, 1.1cqi, 13px)', fontWeight: 600, textAlign: 'right',
