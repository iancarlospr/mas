...
export function M26Slide({ scan }: { scan: ScanWithResults }) {
        ...
        <div style={{ display: 'flex', gap: '0.6em', marginBottom: '0.6em' }}>
          <div style={{
            ...
            <p className="font-data tabular-nums" style={{
              fontSize: 'clamp(1px, 2.2cqi, 26px)', fontWeight: 700, lineHeight: 1,
              color: totalOrganic > 0 ? scoreColor(modScore ?? 50) : 'var(--gs-mid)',
            }}>
              {totalOrganic > 0 ? totalOrganic.toLocaleString() : '—'}
            </p>
            <p className="font-data uppercase" style={{ fontSize: 'clamp(1px, 1cqi, 12px)', color: 'var(--gs-base)', letterSpacing: '0.08em', marginTop: '0.3em' }}>
          ...
          {rawKeywords.length > 0 && rawKeywords[0] && (
            <div style={{
              ...
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.5cqi, 18px)', color: 'var(--gs-light)', fontWeight: 600, lineHeight: 1.2 }}>
                ...
                return (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.4em' }}>
                    <span className="font-data tabular-nums" style={{
                      fontSize: 'clamp(1px, 1.1cqi, 13px)', fontWeight: 700, minWidth: '2.2em', textAlign: 'right',
                    ...
                    <span className="font-data tabular-nums" style={{
                      fontSize: 'clamp(1px, 1.15cqi, 14px)', color: 'var(--gs-light)', fontWeight: 600,
