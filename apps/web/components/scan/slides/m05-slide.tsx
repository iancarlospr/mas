        ...
        <div style={{ display: 'flex', gap: '3%' }}>
          ...
          <div style={{ flex: '0 0 30%', display: 'flex', flexDirection: 'column', gap: '0.4em', justifyContent: 'flex-start' }}>
            ...
            <div style={{ marginTop: '0.3em' }}>
              <p className="font-data" style={{ fontSize: 'clamp(7px, 1.1cqi, 13px)', color: 'var(--gs-mid)', marginBottom: '0.2em' }}>
                Tool Count
              </p>
              <p className="font-data tabular-nums" style={{ fontSize: 'clamp(8px, 2cqi, 22px)', fontWeight: 700, color: 'var(--gs-light)', lineHeight: 1 }}>
                {toolCount}
              </p>
            </div>
