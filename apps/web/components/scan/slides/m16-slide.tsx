      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '3%' }}>
            ...
            {articleCount != null && (
              <div style={{
                ...
                <p className="font-data tabular-nums" style={{
                  fontSize: 'clamp(1px, 5cqi, 60px)', fontWeight: 700, lineHeight: 1,
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.3em' }}>
            <p className="font-display uppercase" style={{ fontSize: 'clamp(1px, 1.2cqi, 13px)', letterSpacing: '0.18em', color: 'var(--gs-base)', marginBottom: '0.1em' }}>
              Media Assets
            </p>
            <CheckItem
