          ...
          <div style={{
            ...
            {top5.map((c, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.5em' }}>
                ...
                <span className="font-data" style={{ fontSize: 'clamp(1px, 1.1cqi, 13px)', color: 'var(--gs-light)', lineHeight: 1.2 }}>
                  {c.name}
                </span>
                <span className="font-data tabular-nums" style={{ fontSize: 'clamp(1px, 1.1cqi, 13px)', color: 'var(--gs-mid)', marginLeft: 'auto', lineHeight: 1.2 }}>
