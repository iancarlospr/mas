    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <span className="font-data" style={{ fontSize: 'clamp(16px, 1.8cqi, 22px)', color: 'rgba(255,178,239,0.2)', padding: '0 1.2em', alignSelf: 'flex-start', marginTop: '0.15em', fontWeight: 300 }}>+</span>
