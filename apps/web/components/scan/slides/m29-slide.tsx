        ...
        <div style={{ display: 'flex', gap: '0.5em', marginBottom: '0.6em' }}>
          {[
            ...
            <div key={i} style={{
              ...
              <p className="font-data tabular-nums" style={{ fontSize: 'clamp(8px, 1.6cqi, 20px)', fontWeight: 700, lineHeight: 1.2, color: s.color }}>
                {s.value}
              </p>
        ...
        {topEight.length > 0 && (
          <div>
            ...
            <div style={{
              ...
              <span className="font-data" style={{ fontSize: 'clamp(7px, 1cqi, 12px)', color: 'var(--gs-mid)' }}>Domain</span>
              <span className="font-data" style={{ fontSize: 'clamp(7px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right' }}>Shared KWs</span>
              <span className="font-data" style={{ fontSize: 'clamp(7px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right' }}>Avg Pos</span>
              <span className="font-data" style={{ fontSize: 'clamp(7px, 1cqi, 12px)', color: 'var(--gs-mid)', textAlign: 'right' }}>ETV</span>
            </div>
            {/* Table rows */}
              ...
              {topEight.map((comp, i) => (
                <div key={i} style={{
                  ...
                  <span className="font-data tabular-nums" style={{
                    fontSize: 'clamp(7px, 1.1cqi, 13px)', textAlign: 'right', fontWeight: 600,
