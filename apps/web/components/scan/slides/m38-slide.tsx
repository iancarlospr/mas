      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '3%' }}>
          ...
          <div style={{ flex: '1 1 45%', display: 'flex', flexDirection: 'column', gap: '0.4em' }}>
            ...
            {/* Business name */}
            {businessName && (
              <p className="font-data" style={{ fontSize: 'clamp(8px, 1.6cqi, 18px)', fontWeight: 700, color: 'var(--gs-light)', lineHeight: 1.2 }}>
                {businessName}
              </p>
            )}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6em' }}>
              {profileRating != null && (
                <>
                  <span className="font-data tabular-nums" style={{ fontSize: 'clamp(10px, 2.5cqi, 30px)', fontWeight: 700, color: 'var(--gs-light)', lineHeight: 1 }}>
              ...
              {profileReviewCount != null && (
                <span className="font-data" style={{ fontSize: 'clamp(7px, 1.2cqi, 14px)', color: 'var(--gs-mid)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15em', marginTop: '0.2em' }}>
              {profileAddress && (
                <p className="font-data" style={{ fontSize: 'clamp(7px, 1.15cqi, 13px)', color: 'var(--gs-mid)' }}>
                  {profileAddress}
                </p>
              )}
              {profilePhone && (
              ...
              {profileWebsite && (
                <p className="font-data" style={{ fontSize: 'clamp(7px, 1.15cqi, 13px)', color: 'var(--gs-base)', opacity: 0.7 }}>
                  {profileWebsite}
                </p>
              )}
            </div>
