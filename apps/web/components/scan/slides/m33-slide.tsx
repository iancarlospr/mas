        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.6em', justifyContent: 'center' }}>
          ...
          <div style={{
            ...
            {coreBrand && (<>
              ...
              <p className="font-data" style={{
                fontSize: 'clamp(22px, 2.8cqi, 34px)', fontWeight: 700, color: 'var(--gs-base)', lineHeight: 1,
              }}>
                &ldquo;{coreBrand.keyword}&rdquo;
              </p>
              <p className="font-data uppercase" style={{
                fontSize: 'clamp(12px, 0.9cqi, 12px)', color: 'var(--gs-mid)',
          ...
          {brandedTraffic > 0 && (
            <div style={{ textAlign: 'center' }}>
              <p className="font-data tabular-nums" style={{
                fontSize: 'clamp(18px, 2cqi, 24px)', fontWeight: 700, lineHeight: 1, color: 'var(--gs-terminal)',
              }}>
                ...
                return (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.5em' }}>
                    <span className="font-data" style={{
                      fontSize: 'clamp(12px, 1.2cqi, 14px)', color: 'var(--gs-light)',
