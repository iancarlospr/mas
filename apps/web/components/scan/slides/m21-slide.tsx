...
const SHOWCASE_BRANDS: Record<string, ShowcaseBrand> = {
  ...
  senzary: {
    ...
    avatarBg: '#0D2137',
    avatarLetter: 'S',
    postText: 'Every acre of your farm is generating data. Soil moisture shifts. Temperature swings. Wind patterns changing. Most growers don\'t see it until the crop is already stressed. Senzary makes the invisible visible — wireless sensors, solar-powered gateways, live dashboards from anywhere.',
    ...
    linkHeadline: 'Your Field Is Talking.',
    linkDescription: 'Wireless IoT · Smart Agriculture · Zero Cabling',
    ctaLabel: 'Learn More',
  },
};
