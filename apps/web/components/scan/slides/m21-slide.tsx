  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p className="font-data" style={{ fontSize: 'clamp(12px, 1.2cqi, 14px)', color: 'var(--gs-light)', fontWeight: 600, lineHeight: 1.2 }}>
          {name}
        </p>
        <p className="font-data" style={{ fontSize: 'clamp(12px, 1.1cqi, 13px)', color: active ? 'var(--gs-terminal)' : 'var(--gs-mid)', lineHeight: 1.2 }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4em', height: '100%' }}>
      ...
      {activePlatforms === 0 && (
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <p className="font-data" style={{ fontSize: 'clamp(12px, 1.2cqi, 14px)', color: 'var(--gs-mid)', opacity: 0.6, textAlign: 'center' }}>
