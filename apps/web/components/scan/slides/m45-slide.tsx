...
const T = {
  overline:  'clamp(13px, 1.4cqi, 15px)',
  section:   'clamp(14px, 1.6cqi, 16px)',
  body:      'clamp(13px, 1.35cqi, 15px)',
  detail:    'clamp(12px, 1.25cqi, 14px)',
  pill:      'clamp(12px, 1.15cqi, 13px)',
  stat:      'clamp(22px, 3cqi, 36px)',
  statLabel: 'clamp(12px, 1.25cqi, 14px)',
};
...
export function M45Slide({ scan }: { scan: ScanWithResults }) {
  ...
  return (
    ...
    >
      <div className="relative z-10 h-full flex flex-col overflow-hidden" style={{ padding: '1.5% 3.5% 0', paddingBottom: 'clamp(16px, 2.8cqi, 28px)' }}>
