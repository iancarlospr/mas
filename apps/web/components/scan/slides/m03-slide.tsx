        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', marginBottom: '0.6em' }}>
          ...
          {lcpSec != null ? (
            ...
            <div style={{ textAlign: 'center', flex: '0 0 auto' }}>
              ...
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.5cqi, 18px)', color: 'var(--gs-mid)', marginTop: '-0.6em' }}>—</p>
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.1cqi, 13px)', color: 'var(--gs-mid)', marginTop: '0.15em' }}>LCP</p>
            </div>
          )}
          ...
          {cls != null ? (
            ...
            <div style={{ textAlign: 'center', flex: '0 0 auto' }}>
              ...
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.5cqi, 18px)', color: 'var(--gs-mid)', marginTop: '-0.6em' }}>—</p>
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.1cqi, 13px)', color: 'var(--gs-mid)', marginTop: '0.15em' }}>CLS</p>
            </div>
          )}
          ...
          {fcpSec != null ? (
            ...
            <div style={{ textAlign: 'center', flex: '0 0 auto' }}>
              ...
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.5cqi, 18px)', color: 'var(--gs-mid)', marginTop: '-0.6em' }}>—</p>
              <p className="font-data" style={{ fontSize: 'clamp(1px, 1.1cqi, 13px)', color: 'var(--gs-mid)', marginTop: '0.15em' }}>FCP</p>
            </div>
          )}
        </div>
