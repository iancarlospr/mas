      ...
      >
        <div className="relative z-10 h-full flex flex-col overflow-hidden" style={{ padding: '1.5% 3.5% 1%' }}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center" style={{ gap: '1em' }}>
            <span className="font-display" style={{ fontSize: 'clamp(36px, 5cqi, 60px)', opacity: 0.15, color: 'var(--gs-base)' }}>
              M40
            </span>
  ...
  return (
    ...
    >
      <div className="relative z-10 h-full flex flex-col overflow-hidden" style={{ padding: '1.5% 3.5% 1%' }}>
        ...
        {/* Headline */}
        <h2 className="font-display" style={{ fontSize: 'clamp(20px, 2.8cqi, 32px)', fontWeight: 700, lineHeight: 1.15, color: 'var(--gs-light)', marginBottom: '0.5em', flexShrink: 0, borderLeft: '3px solid var(--gs-base)', paddingLeft: '0.6em' }}>
          {headline}
        </h2>
          ...
          <div style={{
            ...
            {stats.map((s) => (
              <div key={s.label} style={{
                ...
                <p className="font-data tabular-nums" style={{ fontSize: 'clamp(18px, 2.2cqi, 26px)', fontWeight: 700, color: s.color, lineHeight: 1 }}>
                  {s.value}
                </p>
