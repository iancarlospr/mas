      ...
      <div style={{
          ...
          <div style={{ flex: '1 1 55%', overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  {allErrors.slice(0, 6).map((msg, i) => (
                    <p key={i} style={{
                      ...
                      fontSize: 'clamp(12px, 1.05cqi, 13px)',
            ...
            {allErrors.length === 0 && (
              <div style={{
                ...
                <span className="font-display" style={{ fontSize: 'clamp(18px, 2cqi, 24px)', color: 'var(--gs-terminal)', fontWeight: 700 }}>
                  {'\u2713'}
                </span>
                <span className="font-data" style={{ fontSize: 'clamp(13px, 1.3cqi, 15px)', color: 'var(--gs-terminal)', marginLeft: '0.5em' }}>
                    ...
                    return (
                      <div key={i} style={{ display: 'flex', alignItems: 'baseline', gap: '0.3em' }}>
                        <span className="font-data tabular-nums" style={{
                          fontSize: 'clamp(12px, 1.1cqi, 13px)', fontWeight: 700,
        ...
        {errorTools.length > 0 && (
          <div style={{ display: 'flex', gap: '0.3em', flexWrap: 'wrap', marginTop: '0.4em', alignItems: 'center' }}>
            <span className="font-data uppercase" style={{ fontSize: 'clamp(12px, 1cqi, 12px)', color: 'var(--gs-mid)', letterSpacing: '0.05em' }}>
              Monitoring:
            </span>
