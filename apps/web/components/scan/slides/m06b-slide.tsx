...
export function M06bSlide({ scan }: { scan: ScanWithResults }) {
  ...
  const vizContent = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5em' }}>
          ...
          <div style={{ marginBottom: '0.3em' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '0.15em' }}>
              ...
              <span className="font-data tabular-nums" style={{
                fontSize: 'clamp(8px, 1.6cqi, 18px)', fontWeight: 700,
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.8em', marginTop: '0.2em' }}>
        {loadTimeMs > 0 && (
          <div style={{
            ...
            <span className="font-data tabular-nums" style={{ fontSize: 'clamp(8px, 1.8cqi, 20px)', fontWeight: 700, color: loadColor }}>
      ...
      {/* H1 if available */}
      {h1Text && (
        <p className="font-data" style={{ fontSize: 'clamp(7px, 1.15cqi, 14px)', color: 'var(--gs-mid)', fontStyle: 'italic', marginTop: '0.1em' }}>
