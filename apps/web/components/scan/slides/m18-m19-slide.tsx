            ...
            <div style={{ display: 'flex', gap: '0.4em', marginBottom: '0.5em' }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <p className="font-data tabular-nums" style={{ fontSize: 'clamp(1px, 1.7cqi, 20px)', fontWeight: 700, lineHeight: 1, color: s.color }}>
                    {s.value}
                  </p>
                  <p className="font-data uppercase" style={{ fontSize: 'clamp(1px, 0.85cqi, 12px)', color: 'var(--gs-base)', letterSpacing: '0.06em', marginTop: '0.2em' }}>
                    {s.label}
                  </p>
                </div>
              ))}
            </div>
            <p className="font-display uppercase" style={{ fontSize: 'clamp(1px, 1.2cqi, 13px)', letterSpacing: '0.18em', color: 'var(--gs-base)', marginBottom: '0.25em' }}>
              Investor Relations
            </p>
