        ...
        <div style={{ display: 'flex', gap: '3%' }}>
          ...
          <div style={{ flex: '1 1 45%', display: 'flex', flexDirection: 'column', gap: '0.4em' }}>
            ...
            <div style={{
              ...
              <span className="font-data tabular-nums" style={{ fontSize: 'clamp(28px, 3.5cqi, 42px)', fontWeight: 700, color: co2Color, lineHeight: 1 }}>
                {co2PerView ?? (co2Grams != null ? `${co2Grams.toFixed(2)}g` : '—')}
              </span>
              <span className="font-data uppercase" style={{ fontSize: 'clamp(12px, 1.1cqi, 13px)', color: 'var(--gs-base)', letterSpacing: '0.1em' }}>
                CO₂ per view
              </span>
            </div>
