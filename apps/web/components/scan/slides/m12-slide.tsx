          ...
          {checklist.map((item) => {
            ...
            return (
              <div key={item.label} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.4em' }}>
                <span className="font-display" style={{ fontSize: 'clamp(8px, 1.6cqi, 18px)', fontWeight: 700, color: style.color, lineHeight: 1, flexShrink: 0 }}>
                  {style.symbol}
                </span>
                <div>
                  <p className="font-data" style={{ fontSize: 'clamp(7px, 1.3cqi, 14px)', color: 'var(--gs-light)', lineHeight: 1.3 }}>
                    {item.label}
                  </p>
                  <p className="font-data" style={{ fontSize: 'clamp(7px, 1.2cqi, 13px)', color: 'var(--gs-mid)', lineHeight: 1.3 }}>
                    {item.detail}
                  </p>
                </div>
              </div>
