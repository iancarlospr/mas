    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5em' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3em' }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '0.1em' }}>
            <span className="font-data" style={{ fontSize: 'clamp(12px, 1.15cqi, 14px)', color: 'var(--gs-light)' }}>
              Image Alt Text
            </span>
            <span className="font-data tabular-nums" style={{ fontSize: 'clamp(12px, 1.15cqi, 14px)', fontWeight: 600, color: coverageColor(altCoverage) }}>
              {altCoverage}%
            </span>
          </div>
          <HorizontalBar value={altCoverage} max={100} color={coverageColor(altCoverage)} />
          <span className="font-data" style={{ fontSize: 'clamp(12px, 1cqi, 12px)', color: 'var(--gs-mid)' }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '0.1em' }}>
            ...
            <span className="font-data tabular-nums" style={{ fontSize: 'clamp(12px, 1.15cqi, 14px)', fontWeight: 600, color: coverageColor(labelCoverage) }}>
              {labelCoverage}%
            </span>
          </div>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '0.1em' }}>
            ...
            <span className="font-data tabular-nums" style={{ fontSize: 'clamp(12px, 1.15cqi, 14px)', fontWeight: 600, color: coverageColor(linkCoverage) }}>
              {linkCoverage}%
            </span>
          </div>
      ...
      {overlays.length > 0 && (
        <div style={{
          ...
          <span className="font-data" style={{ fontSize: 'clamp(12px, 1.1cqi, 13px)', color: 'var(--gs-critical)' }}>
