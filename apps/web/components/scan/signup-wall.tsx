...
export function SignupWall({ domain, scanUrl }: SignupWallProps) {
  ...
  // Store pending URL before any redirect
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Card */}
      <div className="relative bg-surface border border-border rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4">
        <div className="text-center mb-6">
          <h2 className="font-heading text-h3 text-primary mb-2">
            {mode === 'register' ? 'Sign up to complete your scan' : 'Log in to complete your scan'}
          </h2>
          <p className="text-sm text-muted">
            Your audit of <strong className="text-primary">{domain}</strong> is ready to run.
            Create a free account to see all 45 modules.
          </p>
        </div>
