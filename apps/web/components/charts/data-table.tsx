      ...
      {exportable && (
        <div className="flex justify-end mb-2">
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-muted hover:text-primary transition-colors px-2 py-1 rounded border border-[#E2E8F0] hover:border-[#94A3B8]"
          >
            ...
            >
              ...
              {columns.map((col) => (
                <th
                  key={col.key}
                  className={cn(
                    'font-heading text-[11px] font-semibold text-[#64748B] uppercase tracking-wide px-3',
                    compact ? 'py-1.5' : 'py-2',
            ...
            {pageData.map((row, ri) => {
              ...
              return (
                <tr
                  key={ri}
                  className={cn(
                    'border-t border-[#F1F5F9] transition-colors',
                    ri % 2 === 0 ? 'bg-white' : 'bg-[#FAFBFC]',
                    isSelected && 'bg-[#1A1A2E]/[0.03]',
                    'hover:bg-[#F8FAFC]',
                  )}
                >
                  {selectable && (
        ...
        <div className="flex items-center justify-between mt-3 text-xs text-muted">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              disabled={page === 0}
              className="px-2 py-1 rounded border border-[#E2E8F0] hover:border-[#94A3B8] disabled:opacity-40"
            >
              Previous
            </button>
