...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gs-ink flex items-center justify-center relative">
      ...
      <div className="relative text-center px-gs-4">
        ...
        <div className="bevel-raised bg-gs-chrome p-gs-8 max-w-md mx-auto">
          <h1 className="font-data text-[64px] font-bold text-gs-red leading-none mb-gs-4">
            404
          </h1>
