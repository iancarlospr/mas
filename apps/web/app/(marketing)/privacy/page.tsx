...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="font-heading font-800 text-3xl text-[#1A1A2E]">Privacy Policy</h1>
      ...
      <div className="mt-8 space-y-6 text-[#334155] leading-relaxed">
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">1. Data We Collect</h2>
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">2. How We Use Your Data</h2>
          <ul className="mt-2 list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">3. Third-Party Processors</h2>
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">4. Cookies</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">5. Email Communications</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">6. Data Retention</h2>
          <ul className="mt-2 list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">7. Your Rights (GDPR/CCPA)</h2>
          ...
          <p className="mt-2">
            ...
            <a href="mailto:privacy@marketingalphascan.com" className="text-[#0F3460] underline">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">8. Geographic Restrictions</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">9. Changes to This Policy</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading font-700 text-xl text-[#1A1A2E]">10. Contact</h2>
          <p className="mt-2">
