  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', width: '192px', height: '192px', background: 'radial-gradient(ellipse at 50% 45%, #1A161A 0%, #080808 100%)' }} />

        {/* Glow halo (icon.svg ellipse) */}
        <div style={{ position: 'absolute', width: '120px', height: '132px', borderRadius: '50%', background: 'radial-gradient(ellipse, rgba(255,178,239,0.08) 0%, transparent 70%)', top: '24px', left: '36px' }} />

        {/* Ghost — icon.svg viewBox="0 0 32 32" */}
        <svg width="140" height="150" viewBox="0 0 32 32" style={{ imageRendering: 'pixelated' as 'auto', position: 'relative' }}>
          {/* Body (#FFF0FA) */}
