...
export function ReportPaywall({ scanId }: ReportPaywallProps) {
  ...
  return (
    <div className="max-w-lg mx-auto text-center py-gs-12">
      ...
      <h1 className="font-system text-[clamp(20px,3vw,32px)] font-bold text-gs-ink mb-gs-4">
        Declassify the Executive Report
      </h1>
      <p className="font-data text-data-sm text-gs-muted mb-gs-2">
        The full intelligence dossier with:
      </p>
      <ul className="font-data text-data-sm text-gs-muted text-left max-w-xs mx-auto space-y-gs-2 mb-gs-6">
