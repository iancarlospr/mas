...
INSERT INTO beta_invites (code, name, tier, scan_credits, chat_credits, max_uses) VALUES
  ...
  ('xavier-p4w8',       'Xavier',         'standard', 3, 25, 1),
  ('hernan-d6j5',       'Hernan',         'standard', 3, 25, 1),
  ('alex-r3n7',         'Alex',           'standard', 3, 25, 1),
  ('brendan-v8c1',      'Brendan',        'standard', 3, 25, 1),
  ('humberto-f2q9',     'Humberto',       'standard', 3, 25, 1),
  ('kris-t5h4',         'Kris',           'standard', 3, 25, 1),
  ('rubi-m7x6',         'Rubi',           'standard', 3, 25, 1),
  ('jl-w3k8',           'JL',             'standard', 3, 25, 1),
  ('aileen-g9p2',       'Aileen',         'standard', 3, 25, 1),
  ('pedro-n4v7',        'Pedro',          'standard', 3, 25, 1),
  ('adam-c8f3',         'Adam',           'standard', 3, 25, 1),
  ('popular-bank-h6r1', 'Popular Bank',   'standard', 3, 25, 1),
  ('senzary-j2m9',      'Senzary',        'standard', 3, 25, 1),
  ('santander-q5w4',    'Santander USA',  'standard', 3, 25, 1),
  ('ryder-b7t6',        'Ryder',          'standard', 3, 25, 1),
  ('investpr-x3k8',     'InvestPR',       'standard', 3, 25, 1),
  ('torlanco-f9n2',     'Torlanco',       'standard', 3, 25, 1),
  ('beta-guest-a4d7',   'Guest Invite 1', 'standard', 3, 25, 1),
  ('beta-guest-m8p3',   'Guest Invite 2', 'standard', 3, 25, 1),
  ('beta-guest-r6w1',   'Guest Invite 3', 'standard', 3, 25, 1)
